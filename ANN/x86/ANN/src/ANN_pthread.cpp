...
ANN_pthread::ANN_pthread ( int* _num_each_layer, int _num_layers, float _study_rate)
{
...
void ANN_pthread::train (const int num_sample, float** _trainMat, float** _labelMat)
{
